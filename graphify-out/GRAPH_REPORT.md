# Graph Report - tikman  (2026-08-20)

## Corpus Check
- 292 files · ~133,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1980 nodes · 3846 edges · 149 communities (130 shown, 19 thin omitted)
...
### Community 0 - "Source of Truth (SOT) - TikMan"
Cohesion: 0.05
...
### Community 5 - "github.com/google/uuid.UUID"
Cohesion: 0.13
Nodes (10): EventHandler, NewEventHandler(), ONTEvent, EventService, formatPowerValue(), MetricsService, ONTMetricsRow, github.com/google/uuid.UUID (+2 more)
...
Cohesion: 0.06
Nodes (153): TestSiteHandler_Create(), TestSiteHandler_Delete(), TestSiteHandler_GetByID(), TestSiteHandler_List(), TestSiteHandler_Update(), SetupSiteHandlerTest(), TestQueryONTMetrics(), NewEventService() (+145 more)
...
Cohesion: 0.18
Nodes (4): ONT, ONTStatus, ONTService, BulkRegisterResult

### Community 13 - "SiteService"
Cohesion: 0.15
...
### Community 15 - "helpers.go"
Cohesion: 0.29
Nodes (7): DecodeZxGponIfIndex(), EncodeZxGponIfIndex(), StatusMap(), TestDecodeZxGponIfIndex(), TestEncodeDecodeRoundTrip(), TestEncodeZxGponIfIndex(), TestStatusMap()

### Community 16 - "AlertRule"
Cohesion: 0.20
Nodes (7): Alarm, AlarmSeverity, AlarmStatus, AlarmType, AlertCondition, AlertMetricType, AlertRule

### Community 17 - "OLTService"
Cohesion: 0.14
Nodes (8): SeedEventsResponse, SeedHandler, NewSeedHandler(), OLTService, MonitoringWorker, context.CancelFunc, context.Context, sync.WaitGroup
...
### Community 19 - "⚠️ Security Concerns & Recommendations"
Cohesion: 0.06
...
### Community 20 - "Setup"
Cohesion: 0.11
Nodes (20): OLTHandler, NewOLTHandler(), NewONTHandler(), Setup(), TestHealthEndpoint(), TestRouterSetup(), NewMemoryStore(), AuditService (+12 more)
...
### Community 24 - "Traffic Statistics Implementation - Complete Summary"
Cohesion: 0.06
...
### Community 37 - "🔒 Security Improvements Summary - TikMan"
Cohesion: 0.07
...
### Community 38 - "🎯 ONT Monitoring Fix - Summary Report"
Cohesion: 0.07
...
### Community 39 - "gorm.io/gorm.DB"
Cohesion: 0.15
Nodes (17): TestOLTHandler_Create(), TestOLTHandler_Delete(), TestOLTHandler_GetByID(), TestOLTHandler_List(), TestOLTHandler_Update(), CreateTestOLT(), SetupAuthHandlerTest(), SetupOLTHandlerTest() (+9 more)

### Community 40 - "🚀 ONT Monitoring Quick Start Guide"
Cohesion: 0.08
...
### Community 41 - "🚀 INSTRUCTIONS TO FIX YOUR ONT MONITORING"
Cohesion: 0.08
...
### Community 42 - "ONT Metrics Display Fix - Documentation"
Cohesion: 0.08
...
### Community 43 - "🔧 Troubleshooting: Duplicate ONT Serial Numbers"
Cohesion: 0.09
...
### Community 44 - "ONTLocation"
Cohesion: 0.29
Nodes (12): ONTLocation, buildTopologyStructure(), copyONTAttributes(), mapPhaseToRunState(), queryPortONTAttributes(), walkONUDescriptions(), walkONUDeviceTypes(), walkONUNames() (+4 more)
...
Cohesion: 0.32
Nodes (9): formatTimeValue(), main(), GetLastOfflineReason(), GetLastOfflineTime(), GetLastOnlineTime(), PollOntStatus(), encodeOnuIDIfIndex(), parseZteHexTimestamp() (+1 more)

### Community 62 - "NewUserService"
Cohesion: 0.22
Nodes (12): CreateDefaultAdmin(), setupSeedTest(), TestCreateDefaultAdmin_NoUsers(), TestCreateDefaultAdmin_UsersExist(), NewUserService(), TestUserService_Create(), TestUserService_Delete(), TestUserService_GetByUsername() (+4 more)
...
### Community 67 - "Store"
Cohesion: 0.13
Nodes (9): CreateUserRequest, UpdateUserRequest, Data, MemoryStore, Store, redis.Client, UserRole, sync.RWMutex (+1 more)
...
### Community 73 - "ONTMetrics"
Cohesion: 0.31
Nodes (7): TestDecodeZxGponPower(), TestEncodeZxGponIfIndexMatchesLiveDevice(), decodeZxGponPower(), encodeZxGponIfIndex(), ONTMetrics, pollSNMPInteger(), QueryONTMetricsWithDynamicPort()
...
### Community 94 - "dto.go"
Cohesion: 0.08
Nodes (24): CreateOLTRequest, CreateONTRequest, CreateSiteRequest, ErrorResponse, LoginRequest, LoginResponse, OLTResponse, ONTResponse (+16 more)
...
### Community 108 - "github.com/gin-gonic/gin.HandlerFunc"
Cohesion: 0.40
...
### Community 127 - "lookupByPortAndONT"
Cohesion: 0.40
Nodes (3): T, MonitoringWorker, lookupByPortAndONT()

### Community 128 - "setupAuthTest"
Cohesion: 0.27
...
Cohesion: 0.12
Nodes (11): ONTHandler, UserHandler, ToUserResponse(), OLTHandler, mapStatusToRunState(), OLTHandler, isDuplicateError(), NewUserHandler() (+3 more)
...
### Community 158 - "DiscoverOLTTopology"
Cohesion: 0.19
Nodes (14): main(), newSNMPClient(), TestToInt64(), DiscoverOLTTopology(), decodeOnuIDIfIndex(), decodeOnuTypeIfIndex(), T, walkONTMetricTable() (+6 more)
...
- **Why does `createTestONT()` connect `testing.T` to `ONTService`, `github.com/google/uuid.UUID`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `NewONTService()` connect `testing.T` to `gorm.io/gorm.DB`, `collectMetrics`, `ONTService`, `OLTService`, `Setup`, `github.com/gin-gonic/gin.Context`, `time.Time`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `createTestOLT()` connect `testing.T` to `github.com/google/uuid.UUID`, `dto.go`, `gorm.io/gorm.DB`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
