...
## Summary
- 1980 nodes · 3846 edges · 142 communities (122 shown, 20 thin omitted)
...
Cohesion: 0.12
Nodes (12): SiteResponse, ONTEvent, EventService, formatPowerValue(), MetricsService, ONTMetricsRow, github.com/google/uuid.UUID, time.Time (+4 more)
...
Cohesion: 0.05
Nodes (164): TestOLTHandler_Create(), TestOLTHandler_Delete(), TestOLTHandler_GetByID(), TestOLTHandler_List(), TestOLTHandler_Update(), TestSiteHandler_Create(), TestSiteHandler_Delete(), TestSiteHandler_GetByID() (+156 more)
...
Cohesion: 0.13
Nodes (9): CreateONTRequest, UpdateONTRequest, collectMetrics(), main(), mapRunStateToStatus(), ONT, ONTStatus, ONTService (+1 more)
...
Cohesion: 0.09
Nodes (13): SeedEventsResponse, SeedHandler, ToOLTResponse(), autoDiscoverONTMetrics(), OLTHandler, OLTHandler, OLTHandler, NewSeedHandler() (+5 more)
...
### Community 20 - "Setup"
Cohesion: 0.18
Nodes (12): OLTHandler, NewOLTHandler(), Setup(), TestHealthEndpoint(), TestRouterSetup(), NewMemoryStore(), AuditService, NewAuditService() (+4 more)
...
### Community 67 - "Store"
Cohesion: 0.19
Nodes (5): Data, MemoryStore, Store, redis.Client, sync.RWMutex
...
### Community 94 - "dto.go"
Cohesion: 0.16
Nodes (16): CreateOLTRequest, CreateSiteRequest, ErrorResponse, LoginRequest, LoginResponse, OLTResponse, ONTResponse, TestConnectionRequest (+8 more)
...
### Community 106 - "main"
Cohesion: 0.17
Nodes (10): main(), Config, Load(), validateConfig(), Connect(), TestConnect_InvalidConfig(), New(), TestNew_InvalidLogLevel() (+2 more)
...
Cohesion: 0.25
Nodes (11): AuthHandler, NewAuthHandler(), setupAuthTest(), TestAuthHandler_Login_InvalidCredentials(), TestAuthHandler_Login_Success(), TestAuthHandler_Login_UserNotFound(), TestAuthHandler_Logout(), TestAuthHandler_Me_NoUserContext() (+3 more)
...
Cohesion: 0.09
Nodes (17): ONTHandler, SiteHandler, UserHandler, ToSiteResponse(), ToUserResponse(), OLTHandler, mapStatusToRunState(), OLTHandler (+9 more)
...
Cohesion: 0.32
Nodes (10): AuthMiddleware(), redis.Client, setupTestRedis(), setupTestRouter(), TestAuthMiddleware_InvalidToken(), TestAuthMiddleware_NoToken(), TestAuthMiddleware_ValidToken(), HTTPSRedirect() (+2 more)
...
### Community 153 - "NewOLTValidatorService"
Cohesion: 0.33
Nodes (8): OLTValidatorService, NewOLTValidatorService(), setupValidatorTestDB(), TestNewOLTValidatorService(), TestValidateCreate_LocalhostSSH(), TestValidateIPNotDuplicate_Duplicate(), TestValidateIPNotDuplicate_NoDuplicate(), TestValidationResult_StructureExists()

### Community 158 - "ONTLocation"
Cohesion: 0.06
Nodes (56): formatTimeValue(), main(), main(), GetLastOfflineReason(), GetLastOfflineTime(), GetLastOnlineTime(), newSNMPClient(), PollOntStatus() (+48 more)

### Community 160 - "MonitoringWorker"
Cohesion: 0.39
...
- **Why does `NewONTService()` connect `testing.T` to `ONTService`, `gorm.io/gorm.DB`, `Setup`, `github.com/gin-gonic/gin.Context`, `ONTLocation`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `createTestOLT()` connect `testing.T` to `gorm.io/gorm.DB`, `github.com/google/uuid.UUID`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
