      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <div style={{
            ...
            <svg style={{ width: 28, height: 28, color: 'white' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
          </div>
          <Title level={3} style={{ margin: 0, color: '#ffffff' }}>TikMan</Title>
        ...
        <div style={{ marginTop: 24, paddingTop: 24, borderTop: '1px solid #27272a', textAlign: 'center' }}>
