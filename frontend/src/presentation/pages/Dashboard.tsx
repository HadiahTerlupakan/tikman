        ...
        <Col xs={24} sm={12} xl={user?.role === UserRole.ADMIN ? 6 : 8}>
          <DarkCard>
            <Statistic
              ...
              value={activeOlts}
              loading={oltsLoading}
              suffix={<span style={{ color: '#71717a' }}>/ {olts?.length || 0}</span>}
              valueStyle={{ color: '#3ecf8e' }}
            ...
            <Row gutter={[16, 16]}>
              <Col xs={24} sm={8}>
                <Card style={{ textAlign: 'center', background: '#14532d', border: '1px solid #15803d' }}>
                  ...
                  />
                  <div style={{ color: '#3ecf8e', fontWeight: 500, marginTop: 8 }}>Online</div>
              ...
              <Col xs={24} sm={8}>
                <Card style={{ textAlign: 'center', background: '#18181b', border: '1px solid #27272a' }}>
                  ...
                  />
                  <div style={{ color: '#a1a1aa', fontWeight: 500, marginTop: 8 }}>Offline</div>
              ...
              <Col xs={24} sm={8}>
                <Card style={{ textAlign: 'center', background: '#450a0a', border: '1px solid #dc2626' }}>
                  ...
                  />
                  <div style={{ color: '#ef4444', fontWeight: 500, marginTop: 8 }}>Error</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                ...
                >
                  ...
                  <span style={{ color: '#3ecf8e', fontWeight: 500 }}>{item.status}</span>
                </div>
              ))}
            </div>
          </DarkCard>
